      ...
      <div className="movies-container">
            ...
            movieArr1.map((obj,index)=>{
                return(
                    <div key={obj.id} className="movie-container">
                        <img className="img-circle" key={obj.id} src={`https://image.tmdb.org/t/p/w342//${movieArr1[index].poster_path}`}/>
                    </div>
                )
            })
        }
        ...
        <div className="col2">
        {
            movieArr2.map((obj,index)=>{
                return(
                    <div key={obj.id} className="movie-container">
                        <img className="img-circle" key={obj.id} src={`https://image.tmdb.org/t/p/w342//${movieArr2[index].poster_path}`}/>
                    </div>
                )
            })
        }
